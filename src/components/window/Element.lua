...
return function(Config)
    ...
    -- Ambil Config.TextOffset di awal
    local TextOffset = Config.TextOffset or 0
...
                Element.Justify == "Between" and -TextOffset or 0, -- Menggunakan TextOffset dari Config (44)
                0,
                0
            ),
            AutomaticSize = Element.Justify == "Between" and "Y" or "XY",
...
                    Element.Justify == "Between" and (ImageFrame and -(IconOffset + Element.UIPadding) or 0) or 0,
...
        end
        
        Element.UIElements.Container.TitleFrame.TitleFrame.Size = UDim2.new(1,-(TextOffset + IconOffset),1,0) -- MODIFIKASI AKHIR
    end
    
